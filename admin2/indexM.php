...
<body>
    ...
    <center><h1>Maradona Section</h1></center>
        <br>
        <br>

        <!-- Create a new Post button -->
        <div class="text-center">
            <a href="maradona/createM.php" class="btn btn-outline-dark">+ Create a new post</a>
        </div>
                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center">
                    <div class="card text-white bg-dark mt-5" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <a href="maradona/viewM.php?id=<?php echo $w['id']?>" class="btn btn-light">Read More <span class="text-danger">&rarr;</span></a>
                        </div>
                    </div>
                </div>
            <?php }?>
