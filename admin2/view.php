   ...
   <div class="container mt-5">
        ...
        <?php foreach($query as $q){?>
            <div class="bg-dark p-5 rounded-lg text-white text-center">
                <h1><?php echo $q['header1'];?></h1>
             </div>
            <p class="mt-5 border-left border-dark pl-3"><?php echo $q['para1'];?></p>
        

            <div class="bg-dark p-5 rounded-lg text-white text-center">
                <h1><?php echo $q['header2'];?></h1>

             </div>

             <p class="mt-5 border-left border-dark pl-3"><?php echo $q['para2'];?></p>
